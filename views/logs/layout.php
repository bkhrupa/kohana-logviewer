...
<html lang="en">
  <head>
    ...
    <?php include_once MODPATH .'kohana-logviewer/assets/bootstrap.min.css' ?>
    <?php include_once MODPATH .'kohana-logviewer/assets/style.css' ?>
    </style>

    <script type="text/javascript"> BASEURL = "<?php echo URL::base() ?>";</script>
    <script type="text/javascript">
    <?php include_once MODPATH .'kohana-logviewer/assets/jquery.js' ?>
    </script>
